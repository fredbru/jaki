...
trainTestSplit = oneHotPatterns.shape[0]-400
bar1 = oneHotPatterns[0:trainTestSplit,0:16,:]
bar2 = oneHotPatterns[0:trainTestSplit,16:32,:]

bar1Validate = oneHotPatterns[trainTestSplit:oneHotPatterns.shape[0],0:16,:]
bar2Validate = oneHotPatterns[trainTestSplit:oneHotPatterns.shape[0],16:32,:]
...
model.save("JAKI_Encoder_Decoder_Trained")
